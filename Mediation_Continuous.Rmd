...
fit_mediator<-lm(gcs_baseline ~ sodium_cat+age+gender+ethnicity+unittype+charlson_liver1 +charlson_chf1+mechvent_day01+dialysis+urine+wbc+temperature+respiratoryrate+heartrate+meanbp+ ph+hematocrit+creatinine+albumin+albumin+pco2+bun+glucose+bilirubin+day1meds+day1pao2+day1fio2,
