...
ggplot(data = prop.score)+geom_histogram(aes(x = res))+facet_wrap(~sodium_cat)
...
# apache related variables
                   , sodium_cat_1_df
,family = binomial("probit"),weights = w)
...
family = "binomial",
data =  sodium_cat_1_df,weights = w)
...
```{r,echo=FALSE}
sodium_cat_2_df$wt<-ifelse(sodium_cat_2_df$sodium_cat==0,1/(table(sodium_cat_2_df$sodium_cat)/nrow(sodium_cat_2_df))[1],1/(table(sodium_cat_2_df$sodium_cat)/nrow(sodium_cat_2_df))[2])
...
fit_mediator<-glm(normal_gcs ~ sodium_cat+age+gender+ethnicity+unittype+charlson_liver1 +charlson_chf1+mechvent_day01+dialysis+urine+wbc+temperature+respiratoryrate+heartrate+meanbp+ ph+hematocrit+creatinine+albumin+albumin+pco2+bun+glucose+bilirubin+day1meds+day1pao2+day1fio2,
family = "binomial",
data =  sodium_cat_2_df,weights = w)
...
```{r,echo=FALSE}
sodium_cat_3_df$wt<-ifelse(sodium_cat_3_df$sodium_cat==0,1/(table(sodium_cat_3_df$sodium_cat)/nrow(sodium_cat_3_df))[1],1/(table(sodium_cat_3_df$sodium_cat)/nrow(sodium_cat_3_df))[2])
...
fit_mediator<-glm(normal_gcs ~ sodium_cat+age+gender+ethnicity+unittype+charlson_liver1 +charlson_chf1+mechvent_day01+dialysis+urine+wbc+temperature+respiratoryrate+heartrate+meanbp+ ph+hematocrit+creatinine+albumin+albumin+pco2+bun+glucose+bilirubin+day1meds+day1pao2+day1fio2,
family = "binomial",
data =  sodium_cat_3_df,weights = w)
...
```{r,echo=FALSE}
sodium_cat_4_df$wt<-ifelse(sodium_cat_4_df$sodium_cat==0,1/(table(sodium_cat_4_df$sodium_cat)/nrow(sodium_cat_4_df))[1],1/(table(sodium_cat_4_df$sodium_cat)/nrow(sodium_cat_4_df))[2])
...
fit_mediator<-glm(normal_gcs ~ sodium_cat+age+gender+ethnicity+unittype+charlson_liver1 +charlson_chf1+mechvent_day01+dialysis+urine+wbc+temperature+respiratoryrate+heartrate+meanbp+ ph+hematocrit+creatinine+albumin+albumin+pco2+bun+glucose+bilirubin+day1meds+day1pao2+day1fio2,
family = "binomial",
data =  sodium_cat_4_df,weights = w)
...
```{r,echo=FALSE}
sodium_cat_6_df$wt<-ifelse(sodium_cat_6_df$sodium_cat==0,1/(table(sodium_cat_6_df$sodium_cat)/nrow(sodium_cat_6_df))[1],1/(table(sodium_cat_6_df$sodium_cat)/nrow(sodium_cat_6_df))[2])
...
fit_mediator<-glm(normal_gcs ~ sodium_cat+age+gender+ethnicity+unittype+charlson_liver1 +charlson_chf1+mechvent_day01+dialysis+urine+wbc+temperature+respiratoryrate+heartrate+meanbp+ ph+hematocrit+creatinine+albumin+albumin+pco2+bun+glucose+bilirubin+day1meds+day1pao2+day1fio2,
family = "binomial",
data =  sodium_cat_6_df,weights = w)
...
```{r,echo=FALSE}
sodium_cat_7_df$wt<-ifelse(sodium_cat_7_df$sodium_cat==0,1/(table(sodium_cat_7_df$sodium_cat)/nrow(sodium_cat_7_df))[1],1/(table(sodium_cat_7_df$sodium_cat)/nrow(sodium_cat_7_df))[2])
...
fit_mediator<-glm(normal_gcs ~ sodium_cat+age+gender+ethnicity+unittype+charlson_liver1 +charlson_chf1+mechvent_day01+dialysis+urine+wbc+temperature+respiratoryrate+heartrate+meanbp+ ph+hematocrit+creatinine+albumin+albumin+pco2+bun+glucose+bilirubin+day1meds+day1pao2+day1fio2,
family = "binomial",
data =  sodium_cat_7_df,weights = w)
...
prop.fit<-glm(normal_gcs ~ age+gender+ethnicity+unittype+charlson_liver1 +charlson_chf1+mechvent_day01+dialysis+urine+wbc+temperature+respiratoryrate+heartrate+meanbp+ ph+hematocrit+creatinine+albumin+albumin+pco2+bun+glucose+bilirubin+day1meds+day1pao2+day1fio2,
              data = sodium_cat_8_0,
              family = "binomial")
summary(prop.fit)
