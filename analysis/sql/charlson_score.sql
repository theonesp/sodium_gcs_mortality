...
SELECT
  t1.*,
  (t1.charlson_mets6+t1.charlson_aids6 + t1.charlson_liver3+t1.charlson_stroke2+t1.charlson_renal2+t1.charlson_dm+t1.charlson_cancer2+t1.charlson_leukemia2+t1.charlson_lymphoma2+t1.charlson_mi1+ t1.charlson_chf1+t1.charlson_pvd1+t1.charlson_tia1+t1.charlson_dementia1+t1.charlson_copd1+t1.charlson_ctd1+t1.charlson_pud1+t1.charlson_liver1 + t1.charlson_age_score) AS final_charlson_score
FROM
  t1
ORDER BY
