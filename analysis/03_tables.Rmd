...
vars_in_table1<-c("age", "gender", "AP_grp", "ethnicity", "apachescore", "mechvent_day01", "unittype", "charlson_chf1", "charlson_liver1", "creatinine", "creatinine_great2", "gcs_baseline", "normal_gcs", "hosp_mortality","sodium_cat")
...
vars_in_sup_table1 <- c("sodium_cat", "AP_grp", "ethnicity", "gender", "age", "MAP", "temperature", "heartrate", "respiratoryrate", "mechvent_day01", "day1fio2", "day1pao2", "pco2", "ph", "urine", "creatinine", "albumin", "bilirubin", "wbc", "cirrhosis", "aids", "leukemia", "immunosuppression", "charlson_chf1", "charlson_liver1")
...
stratifyby<-"sodium_cat"
label(dataframe_for_sup_table1$age)<-'Age'
# selects variable to stratify by and label is useful for prettyfying variable names we want to appear on table 1
...
sup_table1_base<-print(CreateTableOne(vars = vars_in_sup_table1
                                   ,strata = stratifyby
                                  , factorVars = cat_variables
    ,data = dataframe_for_sup_table1, addOverall=T),varLabels = T ,nonnormal  = c('temperature','heartrate','respiratoryrate','day1fio2','day1pao2','pco2', 'ph', 'urine', 'bun', 'albumin', 'bilirubin', 'wbc' )
)
