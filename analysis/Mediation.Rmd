...
fit_totaleffect<-glm(as.factor(hosp_mortality)~ sodium_cat+age+gender+ethnicity+unittype+charlson_liver1 +charlson_chf1+mechvent_day01+dialysis+urine+wbc+temperature+respiratoryrate+heartrate+meanbp+ ph+hematocrit+creatinine+albumin+albumin+pco2+bun+glucose+bilirubin+day1meds+day1pao2+day1fio2
...
<!-- ## Mediation analysis: Baseline sodium_cat_5 -->
...
<!-- #treat is the independend variable -->
<!-- mediation_results_cat5 <- mediate(fit_mediator, fit_dv, treat="sodium_cat", mediator="normal_gcs",sims = 200) -->

<!-- mediation_results_cat5_sum<-as.data.frame(extract_mediation_summary(mediation_results_cat5)) -->
<!-- mediation_results_cat5_sum -->

<!-- mediation_results_cat5_sum<-mediation_results_cat5_sum[grepl("treated|Total Effect", rownames(mediation_results_cat5_sum)), ] -->
<!-- ``` -->
