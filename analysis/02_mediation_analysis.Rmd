...
```{r}
# sens.out1 <- medsens(mediation_results_cat1, rho.by = 0.1, effect.type = "indirect", sims = 1000)
# summary(sens.out1)
...
```{r}
# sens.out2 <- medsens(mediation_results_cat2, rho.by = 0.1, effect.type = "indirect", sims = 1000)
# summary(sens.out2)
...
```{r}
# sens.out3 <- medsens(mediation_results_cat3, rho.by = 0.1, effect.type = "indirect", sims = 1000)
# summary(sens.out3)
