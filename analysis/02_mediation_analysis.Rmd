...
sodium_cat +                       
apache_iv+age+gender+ethnicity+unittype+ charlson_liver1 +charlson_chf1+mechvent_day01+AP_grp
...
```{r}
fit_dv<-glm(as.factor(hosp_mortality) ~ normal_gcs + sodium_cat +apache_iv+age+gender+ethnicity+unittype+ charlson_liver1 +charlson_chf1+mechvent_day01+AP_grp
                   + mechvent_day01 
                   , sodium_cat_1_df
           ,family = 'binomial')
summary(fit_dv)
