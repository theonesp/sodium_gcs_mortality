...
sodium_cat_1_df<-sodium_cat_1_df%>%mutate(
  sodium_cat=if_else(sodium_cat==5,'Ref.','cat_1')
)

sodium_cat_2_df<-sodium_cat_2_df%>%mutate(
  sodium_cat=if_else(sodium_cat==5,'Ref.','cat_2')
)

sodium_cat_3_df<-sodium_cat_3_df%>%mutate(
  sodium_cat=if_else(sodium_cat==5,'Ref.','cat_3')
)

sodium_cat_4_df<-sodium_cat_4_df%>%mutate(
  sodium_cat=if_else(sodium_cat==5,'Ref.','cat_4')
)

sodium_cat_6_df<-sodium_cat_6_df%>%mutate(
  sodium_cat=if_else(sodium_cat==5,'Ref.','cat_6')
)

sodium_cat_7_df<-sodium_cat_7_df%>%mutate(
  sodium_cat=if_else(sodium_cat==5,'Ref.','cat_7')
)

sodium_cat_8_df<-sodium_cat_8_df%>%mutate(
  sodium_cat=if_else(sodium_cat==5,'Ref.','cat_8')
)
